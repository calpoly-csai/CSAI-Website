<script lang="ts">
	...
	const officers = [
		...
		{ name: 'Min Hset Hlaing', title: 'Project Lead', image: 'Min_Hset_Hlaing.jpg' },
	...
	const webTeamMembers = [
		{ name: 'Ammara Amin', title: 'Associate Webmaster', image: 'AmmaraAmin.jpg' }
	];
...
<article class="Team">
	...
	<section class="officers">
		...
		<ul class="officer-list">
			{#each meetingFacilitators as { name, title, image }}
				<OfficerCard {name} {title} image={officerPath + image} />
			{/each}
		</ul>
		<h3><br /> Web Team</h3>
